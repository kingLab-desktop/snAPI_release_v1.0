...
if __name__ == "__main__":
    # === Scan Grid Setup ===
    x_range = np.linspace(0,0,1)                  #np.linspace(min x, max x, N) # N is how many evenly spaced points you want in interval [min x, max x]
    y_range = np.linspace(0,0,1)                  #same for y  #create a NxN grid
    num_x = len(x_range)
    num_y = len(y_range)
    ...
    sn.loadIniConfig("C:\\Users\\lbquy\\OneDrive\\Documents\\GitHub\\King-Lab\\Quyen\\snAPI_Lab\\demos\\config\\PH330_Edge.ini")
    ...
    # === PTU File Setup ===
    ptu_path = "C:\\Users\\lbquy\\OneDrive\\Documents\\GitHub\\King-Lab\\Quyen\\snAPI_Lab\\Result\\QuyenTest1126\\7\\Hist_1PTUfile_40Mhz.ptu"
