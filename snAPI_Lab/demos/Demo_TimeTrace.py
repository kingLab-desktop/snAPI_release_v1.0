...
if(__name__ == "__main__"):
    ...
    sn.timeTrace.setHistorySize(10)  # in seconds # num can changed based on how big x-axis you want to see
    
    # you can set a custom file name or path+++
    sn.setPTUFilePath("C:\\Users\\1037 Lab\\Documents\\GitHub\\King-Lab\\Quyen\\snAPI_Lab\\Result\\DemoTiTrPTU.ptu")
    
    # measure 5s (acquisition time)
    sn.timeTrace.measure(900000000, waitFinished=False, savePTU=False) # in milisecond # num can changed
    ...
    while True: 
        ...
        #print( f"Sync rate is: {syncrate}")
        #print( f"Channel 1 rate is: {chan1rate}")
